// Bounds amplios de Venezuela continental e islas principales.
// Se usa bounding box por velocidad/robustez en emergencia; el backend repite la validación.
...
export const VENEZUELA_CENTER = [9.2, -66.6];
